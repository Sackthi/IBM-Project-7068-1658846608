...
COS_API_KEY_ID="ETeFbq6S21shALDgas9ho8A63AFnhjmarIG879y4UW5j"
COS_INSTANCE_CRN= "crn:v1:bluemix:public:cloud-object-storage:global:a/ccb31130b078434398920f5ae4dcf826:dbc83a84-6962-4fa2-8225-a822b4a75291::"


# Create resource s3.ap.cloud-object-storage.appdomain.cloud
...
@app.route('/')
def index():
    files = get_bucket_contents('navaneethanbucket')
