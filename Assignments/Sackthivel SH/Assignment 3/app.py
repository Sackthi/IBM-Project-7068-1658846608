...
COS_API_KEY_ID="0qjqaE-LKSCDowj11B7ZnyokvvA0kPiozlGET-XsYdPs"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/1e88dbd3425d47c39a08f9f75f359bed:3b54506d-fa6a-4671-a269-47c443e87ed2::"
...
@app.route('/')
def index():
    files = get_bucket_contents('sackthibucket')
